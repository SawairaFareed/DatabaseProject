<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceRequest.aspx.cs" Inherits="DisasterProject.ResourceRequest" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Request Resources – Disaster MIS</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-main">
            <div class="card">
                ...
                <asp:DropDownList ID="ddlResource" runat="server" CssClass="form-control"></asp:DropDownList>

                <label>Quantity Requested *</label>
                <asp:TextBox ID="txtQuantity" runat="server" TextMode="Number" CssClass="form-control" placeholder="Enter quantity" />
